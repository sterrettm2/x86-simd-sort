...
BENCH_WITH_VQSORT(uint64_t)
BENCH_WITH_VQSORT(int64_t)
BENCH_WITH_VQSORT(uint32_t)
BENCH_WITH_VQSORT(int32_t)
BENCH_WITH_VQSORT(float)
BENCH_WITH_VQSORT(double)
