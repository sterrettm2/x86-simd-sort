...
static void avx2_qselect(benchmark::State &state)
{
    ...
    for (auto _ : state) {
        avx2_qselect<T>(arr.data(), K, ARRSIZE);
...
BENCHMARK(avx2_qselect<float>)->Arg(10)->Arg(100)->Arg(1000)->Arg(5000);
BENCHMARK(avx2_qselect<uint32_t>)->Arg(10)->Arg(100)->Arg(1000)->Arg(5000);
BENCHMARK(avx2_qselect<int32_t>)->Arg(10)->Arg(100)->Arg(1000)->Arg(5000);